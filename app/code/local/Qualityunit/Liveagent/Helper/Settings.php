...
class Qualityunit_Liveagent_Helper_Settings {
	...
	public function getDefaultWidgetParams() {
	    $attributes = array(
          ...
          array('section' => 'chat','name' => 'chat_not_available_action','value' => 'N'),
          ...
          array('section' => 'contactForm', 'name' => 'form_logourl', 'value' => $this->getLiveAgentUrl() . 'themes/install/_common_templates/img/default-contactwidget-logo.png'),
          ...
          array('section' => 'contactForm','name' => 'online_form_logourl','value' => $this->getLiveAgentUrl() . 'themes/install/_common_templates/img/default-contactwidget-logo.png'),
